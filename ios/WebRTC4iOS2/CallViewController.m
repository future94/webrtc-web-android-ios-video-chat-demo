...
static NSString *const RTCSTUNServerURL = @"turn:webrtc.phpisfuture.com:3478";
static int logY = 0;
...
- (void) candidate:(NSString *)room message:(NSDictionary *)dict {
    ...
    NSString* desc = dict[@"candidate"];
    NSString* sdpMLineIndex = dict[@"sdpMLineIndex"];
    int index = [sdpMLineIndex intValue];
    NSString* sdpMid = dict[@"sdpMid"];
...
didGenerateIceCandidate:(RTCIceCandidate *)candidate{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSDictionary* dict = [[NSDictionary alloc] initWithObjects:@[@"candidate",
                                                                ...
                                                                candidate.sdpMid,
                                                                candidate.sdp]
                                                           forKeys:@[@"type", @"sdpMLineIndex", @"sdpMid", @"candidate"]];
